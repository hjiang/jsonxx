...
NOTE: For older compilers that do not support C++11, please use the "legacy"
branch.
...
h1. Notes about permissive/strict parsing

JSONxx can parse JSON documents in strict or permissive mode. 
...
Strict parsing mode is disabled by default. Check jsonxx::Settings::Strict enum to tweak it.
